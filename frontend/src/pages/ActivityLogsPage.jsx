  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1200px] mx-auto">
      ...
      <div className="bg-white border border-slate-200 p-16 flex flex-col items-center justify-center text-center">
        ...
        <div className="font-display text-lg text-slate-700 mb-1">Activity logs coming soon</div>
        <div className="text-sm text-slate-500">A full audit trail of all asset changes, transfers and user actions will appear here.</div>
      </div>
    </div>
  );
}
